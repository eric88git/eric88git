...
liderança de squads ágeis e infraestrutura de TI.

Atuo na interseção entre **gestão clássica** (PMI, portfólios complexos) e 
**metodologias ágeis** (Scrum, Kanban), buscando entregar valor de forma 
previsível e sustentável.

🎯 Buscando oportunidades como: **Delivery Manager · Project Manager · Product Owner · Scrum Master · COO**
...
- 🎓 PMP (PMI) — em andamento
- 🎓 CSPO (Certified Scrum Product Owner) — em andamento
- 🎓 Pós-graduação em Desenvolvimento Web — IFMG

---

### 📌 Projetos em destaque

- **[Conclua.app](https://conclua.app)** — Plataforma SaaS de Gestão de Alta Performance para Project Managers
